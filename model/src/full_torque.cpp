...
class Full_torque: public Template{
public:
	Full_torque():Template(){
		setup_pub_sub();
	}
	...
	void setup_pub_sub() override{
		...
		subscription_rotation = this->create_subscription<vex_message::msg::Vexrotationsensor>("out_rotationsensor_2",10,std::bind(&Full_torque::rotation_callback,this,_1));
	}
